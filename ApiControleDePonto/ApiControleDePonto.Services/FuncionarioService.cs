...
namespace ApiControleDePonto.Services
{
    public class FuncionarioService
    {
        ...
        public void Inserir(Funcionario model)
        {
            try
            {
                var novaSenha = GenerateSHA512String(model.SenhaFuncionario);
                model.SenhaFuncionario = novaSenha;
                ValidarModelFuncionario(model);
                _repositorio.AbrirConexao();
        ...
        private static void ValidarModelFuncionario(Funcionario model, bool isUpdate = false)
        {
            ...
            if (model.EmailFuncionario.Trim().Length < 3 || model.EmailFuncionario.Trim().Length > 255)
